...
namespace Twilio.Voice.iOS
{
    ...
    interface TVOCallOptionsBuilder_CallKit
    {
        ...
        [Export("setUuid:")]
        void SetUuid([NullAllowed] NSUuid uuid);
    }
...
*/
    ...
    interface TVOAudioDeviceRenderer
    {
        ...
        unsafe bool StartRendering(ITVOAudioDevice context);
...
*/
    ...
    interface TVOAudioDeviceCapturer
    {
        ...
        unsafe bool StartCapturing(ITVOAudioDevice context);
...
*/
    ...
    interface TVOCallInvite
    {
        ...
        TVOCall AcceptWithDelegate(ITVOCallDelegate @delegate);
        ...
        TVOCall AcceptWithOptions(TVOAcceptOptions options, ITVOCallDelegate @delegate);
    ...
    partial interface ITVOCallDelegate { }
    ...
    interface TwilioVoice
    {
        ...
        bool HandleNotification(NSDictionary payload, ITVONotificationDelegate @delegate, [NullAllowed] DispatchQueue delegateQueue);
        ...
        TVOCall ConnectWithAccessToken(string accessToken, ITVOCallDelegate @delegate);
        ...
        TVOCall ConnectWithOptions(TVOConnectOptions options, ITVOCallDelegate @delegate);
    }

    partial interface ITVOAudioDevice { }
    partial interface ITVONotificationDelegate { }
    partial interface ITVOCallDelegate { }
