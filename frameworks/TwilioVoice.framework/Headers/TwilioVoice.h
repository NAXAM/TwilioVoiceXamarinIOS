 ...
 *
 *  @see [TVOAudioDevice](TVOAudioDevice.h)
 */
...
/**
   ...
   @discussion The identity provided in the Access Token may only contain alpha-numeric and underscore
   characters. Other characters, including spaces, will result in undefined behavior.
